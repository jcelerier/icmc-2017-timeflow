...
\begin{figure}[h]
	...
	\begin{subfigure}{0.21\textwidth}
		...
		\caption{$f_1$: generates a random note on each bang}
	\end{subfigure}
\begin{subfigure}{0.21\textwidth}
...
\caption{$f_5$: applies a low-pass filter}
\end{subfigure}
...
\begin{figure}[h]
	...
	\caption{The relationships between instances of $f_{1,..5}$ in the program}
\end{figure}
